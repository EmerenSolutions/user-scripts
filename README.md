...
| [Kanji Components](kanji-components/README.md) | Shows whole kanji used as visual components inside the current kanji. | WaniKani | `0.1.15` | [Install](https://raw.githubusercontent.com/EmerenSolutions/user-scripts/main/kanji-components/src/wanikani-kanji-components.user.js) |
...
Safe Auto Commit, Kanji Components, and Review Forecast Open Today therefore
retain their original `wanikani-userscripts` namespace after the repository
rename. New scripts use the current repository URL as their namespace.
